...
function addEntry($client,$name,$mediaType=KalturaMediaType::VIDEO, $profileId = null, $userId='dummyId', $description = 'test media description', $tags = 'test tag', $referenceId = 'testRefID', $categories = null)
{
