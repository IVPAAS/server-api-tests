...
class Client  {
    ...
    connectPolls(callback, port) {


        var events = [
	   {
                "name": "POLLS_PUSH_NOTIFICATIONS",
                args: {
    ...
    addPoll(pollType) {
        ...
        return new Promise(function (resolve, reject) {
            This.kalturaAPI.call(addPoll).then((res) => {
                resolve(res);
            }).
            catch((err) => {
                reject(err);
    ...
    pollVote(pollId, userId, answerIds) {
        let This = this;
        var vote = {
            service: 'poll_poll',
            action: 'vote',
            ...
            return new Promise(function (resolve, reject) {
            This.kalturaAPI.call(vote).then((res) => {
                resolve(res);
            }).
            catch((err) => {
                reject(err);
    ...
    getVotes(pollId,answerIds){
        ...
        return new Promise(function (resolve, reject) {
            This.kalturaAPI.call(getVotes).then((res) => {
                resolve(res);
            }).
            catch((err) => {
                reject(err);
